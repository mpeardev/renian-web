  ...
  return (
    <div className={classes.background}>
      <div className={classes.background__decorate}>
        ...
        <div className={classes.background__decoratePets}>
          <div>
            <Image
              src="/img/pets.png"
              layout="responsive"
      ...
      <section className={classes.about}>
        <div className={classes.about__text}>
          ...
          <p>
            ...
            en cualquier cuidad del Peru, esto mediante el im-
          </p>
        </div>
        ...
        <div className={classes.about__player}>
          ...
          <p>
            <span>Renian</span> permite identificar, registrar y realizar un
            seguimiento a los animales de compañia y no de compañia que habitan
            en cualquier cuidad del Peru, esto mediante el implante de un
            microchip de identificacion animal de standard mundial.
          </p>
        </div>
      </section>
    </Background>
